...
I spent the bginning on this week continuing to train and test neural netwoks, which can be seen below; binary map plots were made for thresholds of 0.5 and 0.2 respectively. I spent the latter part of the week writing my final report for the summer which can be found on the homepage of this website. It donesn't include any of the interesting analysis work that I've done that could be used by the lab in future publications, but provides an overview of the development of the neural networks. 
