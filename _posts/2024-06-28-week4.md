...
From the above image, with a very low threshold, it is clear that many seperate bees are connected in some way, as shown by the light green masses. Regardless, a significantly higher number of bees is being identified when compared to the benchmark output.
